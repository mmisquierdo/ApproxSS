...
#ifndef NON_SEQUENTIAL_PERIOD
	#define NON_SEQUENTIAL_PERIOD !ENABLE_PASSIVE_INJECTION && true
#endif
...
//USER-DEFINED END
	...
	#define IF_NON_SEQUENTIAL_PERIOD(X) X
#else
	#define IF_NON_SEQUENTIAL_PERIOD(X)
#endif
