...
int __attribute__((optimize("O0"))) ApproxSS::start_level(const int64_t level/* = 0*/){ // 1 parametro
	return 0;
}
...
int __attribute__((optimize("O0"))) ApproxSS::next_period(const int64_t period/*= 0*/, int b/*= 0*/)	// 2 parameters
{
	return 0;
}
