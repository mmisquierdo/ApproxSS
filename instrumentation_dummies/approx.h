...
namespace ApproxSS {
	...
	int __attribute__((optimize("O0"))) start_level(const int64_t level = 0); //1 parameters
	...
	int __attribute__((optimize("O0"))) next_period(const int64_t period = 0, int b = 0); // 2 parameters
